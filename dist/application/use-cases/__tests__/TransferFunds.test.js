...
describe("TransferFunds", () => {
    ...
    it("should successfully transfer funds between two accounts", async () => {
        // Create two clients
        const client1 = new Client_1.Client("client1", "John", "Doe", "john@example.com", await bcryptjs_1.default.hash("password", 10), true);
        const client2 = new Client_1.Client("client2", "Jane", "Smith", "jane@example.com", await bcryptjs_1.default.hash("password", 10), true);
